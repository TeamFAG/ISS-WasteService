...
package it.unibo.transporttrolley_t1
...
class Transporttrolley_t1 ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
				...
				state("handleDepositRequest") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("depositRequest(MATERIAL,QUANTITY)"), Term.createTerm("depositRequest(MATERIAL,QUANTITY)"), 
								...
								answer("depositRequest", "pickupDone", "pickupDone(ok)","wasteservice_t"   )  
						}
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
