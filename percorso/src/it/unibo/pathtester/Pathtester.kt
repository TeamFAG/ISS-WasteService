...
class Pathtester ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("doPath") { //this:State
					action { //it:State
						...
						request("dopath", "dopath($Actions,tester)" ,"pathexecutor" )  
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
