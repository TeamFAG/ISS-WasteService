		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t130",targetState="execcmd",cond=whenDispatch("cmd"))
					transition(edgeName="t131",targetState="doStep",cond=whenRequest("step"))
					transition(edgeName="t132",targetState="handleObstacle",cond=whenDispatch("obstacle"))
				...
				state("doStep") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t034",targetState="stepDone",cond=whenTimeout("local_tout_basicrobot_doStep"))   
					transition(edgeName="t035",targetState="stepFail",cond=whenDispatch("obstacle"))
				}	 
